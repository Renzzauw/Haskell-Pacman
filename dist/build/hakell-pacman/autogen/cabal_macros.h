...
/* package haskell-pacman-0.1.0.0 */
#ifndef VERSION_haskell_pacman
#define VERSION_haskell_pacman "0.1.0.0"
#endif /* VERSION_haskell_pacman */
#ifndef MIN_VERSION_haskell_pacman
#define MIN_VERSION_haskell_pacman(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_pacman */
...
#define CURRENT_COMPONENT_ID "haskell-pacman-0.1.0.0-3dC1njWbBKMXTDJP0ZRu0-hakell-pacman"
